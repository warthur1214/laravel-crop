            ...
            operate: {
                ...
                render: function(data, type, row, meta) {
                    ...
                    if(row.is_available==1){
                        _selected = true;
                        str += '<a href="checkSon?id='+row.organ_id+'" class="checkDefault label label-success">查看</a>'
                            +'<span class="checkDefault label label-danger dele" deleId="'+row.organ_id+'">删除</span>'
                            +'<select  class="label label-success isFrozen" onchange="selectItem(this)" freazeId="'+row.organ_id+'">'
                        ...
                        str += '<a href="checkSon?id='+row.organ_id+'" class="checkDefault label label-success">查看</a>'
                            +'<span class="checkDefault label label-danger dele" deleId="'+row.organ_id+'">删除</span>'
                            +'<select  class="label label-warning isFrozen" onchange="selectItem(this)" freazeId="'+row.organ_id+'">'
