                ...
                <table class="table table-bordered">
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="text" class="form-control" id="module_matched_key" name="module_matched_key" placeholder="模块关键词">
                            </td>
                        </tr>
                        <tr>
                            <th>所属平台</th>
                        ...
                        <tr>
                            <th>模块排序</th>
                            <td>
                                <input type="text" class="form-control" id="module_sort" name="module_sort" placeholder="模块排序:1~999">
                            </td>
                        </tr>
                        <tr>
                            <th>是否显示</th>
