...
@section("body")
    ...
    <div class="box box-cus box-cus-form">
        ...
        <div class="box-footer clearfix text-center">
            ...
            <a href="{{env("APP_URL")}}/account/accountList" class="btn btn-default"><i class="fa fa-arrow-left"></i> 返回</a>
        </div>
    </div>
    </body>
@endsection
...
@section("script")
    ...
    <script type="text/javascript" src="{{asset("/public/js/account/addAccount.js")}}"></script>
@endsection
